...
def build_parser():
    ...
    add_book_parser = subparsers.add_parser("add-book", help='Add a book')
    ...
    add_book_parser.add_argument("--due-date", required=True)
    add_book_parser.add_argument("--genre", default="", required=True)
    add_book_parser.set_defaults(func=add_book)

    list_books_parser = subparsers.add_parser("list-books", help="List books")
    ...
    add_review_parser.add_argument("--status", default="reading", choices=Review.allowed_statuses)
